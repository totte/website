	...
	if (!empty($error)) { print $error . "<br />"; } ?>
		<form action='addvote.php' method='post'>
			...
			<p>
				...
				<textarea name='agenda' rows='10' cols='75'><?php if (!empty($_POST['agenda'])) { print htmlentities($_POST['agenda']); } ?></textarea><br />
...
?>
	<form action="tu.php"><input type="submit" class="button" value="<?php  print __("Back"); ?>"></form>
<?php
} else {
