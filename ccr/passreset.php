...
<div class="pgbox">
	...
	<div class="pgboxbody">
		...
		register, please send a message to %sthe administrators%s',
'<a href="mailto://chakra-cabal@googlegroups.com">',
'</a>'); ?></p>
		<form action="" method="post">
