...
echo __("Welcome to the Chakra Community Repo. Please read the %hCCR User Guidelines%h and %hCCR TU Guidelines%h for more information.",
	"<a href=\"http://www.chakraos.org/wiki/index.php?title=Chakra_Community_Repository\">",
	"</a>",
	"<a href=\"http://www.chakraos.org/wiki/index.php?title=How_to_become_a_packager#CCR_Trusted_User\">",
	"</a>"
        );
?>
