...
set_include_path(get_include_path() . PATH_SEPARATOR . 'lib/' . PATH_SEPARATOR . 'lang/' . PATH_SEPARATOR . 'template/');
...
<center>
	<form action="addvote.php"><input type="submit" class="button" value="<?php  print __("Add"); ?>"></form>
</center><br />
