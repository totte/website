...
class GeSHi {
     ...
     * @var string
     */
    var $overall_style = 'font-family:monospace,Courier,"Courier new";';

    /**
     *  The style for the actual code
     * @var string
     */
    var $code_style = 'font: normal normal 1.2em/1.4em monospace; padding:10px; background:none; vertical-align:top;';

    /**
     * The overall class for this code block
     * @var string
     */
    var $overall_class = 'fix';
